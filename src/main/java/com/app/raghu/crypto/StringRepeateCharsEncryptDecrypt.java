...
public class StringRepeateCharsEncryptDecrypt {
	...
	/**
	 * if current char is equal to next char then count++ else add char and count to
	 * StringBuffer. Make currentChar = nextChar, count=1 At last add the
	 * currentChar and count if >1 to SB for last char.
	 */
